...
export const CRAFTER_SKILLS: CrafterSkill[] = [
  ...
  },
  {
    ...
    efficiencyQuality: 100,
    successRate: 100,
    description: '【黄金Lv92】加工の直後に使用するとコンボボーナスでインナークワイエットが+2される（通常の加工系アクションは+1）。',
    icon: getActionIconUrl(1873),
    fallbackIcon: '✨',
    waitDuration: 3,
  },
  {
  ...
  },
  {
    ...
    name: '模範作業',
    enName: 'Careful Synthesis',
    type: 'progression',
    level: 62,
    cpCost: 7,
    efficiencyProgress: 150,
    durabilityCost: 10,
    successRate: 100,
    description: '【黄金Lv62】耐久を消費して、作業を進める。低CPで高効率の主力作業アクション。',
    icon: getActionIconUrl(1986),
    fallbackIcon: '🔨',
    waitDuration: 3,
  },
  {
    ...
    name: '匠の絶技',
    enName: 'Trained Perfection',
    type: 'special',
    level: 100,
    cpCost: 0,
    durabilityCost: 0,
    successRate: 100,
    description: '【黄金Lv100】1回の製作につき1度のみ使用可能。次に使用するアクションの耐久消費を0にする。',
  ...
  },
  {
    id: 'quick_innovation',
    name: 'クイックイノベーション',
    enName: 'Quick Innovation',
    type: 'buff',
    level: 100,
    cpCost: 0,
    durabilityCost: 0,
    successRate: 100,
    description: 'マイスター専用。1回の製作につき1度のみ使用可能。ターンを消費せずにイノベーションの効果(1ターン)を得る。「イノベーション」の効果中は使用不可。',
    icon: getActionIconUrl(1999),
    fallbackIcon: '⚡',
    waitDuration: 1,
  },
  {
    id: 'immaculate_mend',
    name: 'パーフェクトメンド',
    enName: 'Immaculate Mend',
    type: 'durability',
    level: 85,
    cpCost: 112,
    durabilityCost: 0,
    successRate: 100,
    description: '【黄金Lv85】耐久を全回復する。',
    icon: getActionIconUrl(1950),
    fallbackIcon: '💚',
    waitDuration: 3,
  }
];
